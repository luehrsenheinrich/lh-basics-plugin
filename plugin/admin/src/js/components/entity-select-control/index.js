...
export const PostSelectControl = ({ postType = 'post', ...props }) => {
	return <EntitySelectControl {...props} name={postType} />;
};

export const TaxonomySelectControl = ({ taxonomy = 'category', ...props }) => {
